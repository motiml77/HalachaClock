...
class PrintComparisonTablesTest {
    ...
    fun printCsv() {
        ...
        println("CSV_START")
        println("city,date,alot,misheyakir60,netz_mishor,shma_mga_luach,shma_mga16,shma_gra,tfila_mga_luach,tfila_mga16,tfila_gra,chatzot,mincha_gedola,mincha_ketana,plag_yy,shkia,tzeit,tzeit_lechumra,tzeit_shabbat,rt,shaah_sec")
        for (city in cities) {
            for (date in dates) {
