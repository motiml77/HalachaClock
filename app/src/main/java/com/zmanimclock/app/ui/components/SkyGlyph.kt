 ...
 *
 * Drawn, not bundled as an image: it stays sharp at any density and needs no
 * asset pipeline. The desktop app draws the same picture from a copy of this
 * file (desktop/…/ui/SkyGlyph.kt) — keep the two in step.
 *
