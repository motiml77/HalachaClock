...
// The rest of Material's surface ladder, in THIS palette's blue-tinted
// neutral. Left undefined, M3 fills them from its own baseline — a lavender
// grey that every filled Card, the time-picker dial and the bottom sheet then
// wore, visibly clashing with the navy/gold everything else is drawn in.
val SurfaceContainerLowestLight = Color(0xFFFFFFFF)
val SurfaceContainerLowLight = Color(0xFFF5F7FC)
val SurfaceContainerHighLight = Color(0xFFEAEEF6)
val SurfaceContainerHighestLight = Color(0xFFE4E9F3)
val SurfaceDimLight = Color(0xFFD9DEE8)
...
val SurfaceContainerLowestDark = Color(0xFF070C17)
val SurfaceContainerLowDark = Color(0xFF0F1729)
val SurfaceContainerHighDark = Color(0xFF1C2740)
val SurfaceContainerHighestDark = Color(0xFF233049)
val SurfaceDimDark = Color(0xFF0B1220)
val SurfaceBrightDark = Color(0xFF2A3652)
