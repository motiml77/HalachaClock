...
internal val ZMAN_GROUPS: List<Pair<String, List<ZmanKind>>> = listOf(
    ...
    "זמני תפילה" to listOf(
        ...
        ZmanKind.SOF_ZMAN_SHMA_MGA_72,
        ZmanKind.SOF_ZMAN_SHMA_GRA,
        ZmanKind.SOF_ZMAN_TFILA_MGA,
        ZmanKind.SOF_ZMAN_TFILA_MGA_72,
...
private val SAMPLE_TIMES = mapOf(
    ...
    ZmanKind.SOF_ZMAN_TFILA_MGA to "10:01",
    ZmanKind.SOF_ZMAN_TFILA_MGA_72 to "10:01",
