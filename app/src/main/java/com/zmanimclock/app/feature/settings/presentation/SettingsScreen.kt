            ...
            Column(
                ...
                if (methodOpen) Text(
                    "הזמנים מחושבים לפי שיטת מרן — לוח אור החיים / " +
                        ...
                        "בגובה היישוב (זריחה–שקיעה בגובה המקום), וחצות בנקודת " +
                        "מעבר השמש. הנץ ושקיעה מישוריים (בגובה פני הים) מוצגים " +
                        "כזמנים נפרדים. הנץ הנראה מטבלאות חי מוצג לתפילת ותיקין " +
