    ...
    Surface(color = cs.background, modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Box(
                ...
                Icon(Icons.Filled.Alarm, contentDescription = null, tint = cs.primary, modifier = Modifier.size(44.dp))
            }
            ...
            Spacer(Modifier.height(18.dp))
            Surface(color = cs.primaryContainer, shape = RoundedCornerShape(20.dp), modifier = Modifier.fillMaxWidth()) {
                Column(
                    Modifier.padding(vertical = 16.dp, horizontal = 18.dp).fillMaxWidth(),
                    horizontalAlignment = Alignment.CenterHorizontally,
                ) {
                    when {
                        ...
                        trial != null -> {
                            ...
                            price?.let {
                                Text("ואחר כך $it $perPeriod", style = MaterialTheme.typography.bodyLarge, color = cs.onPrimaryContainer)
                            }
                        }
                        else -> Text(
